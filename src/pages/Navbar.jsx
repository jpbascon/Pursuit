...
const Navbar = ({ setIsLoggedIn, isLoggedIn, createGoal, setCreateGoal }) => {
  ...
  return (
    <>
      <div onClick={() => { setCreateGoal(false) }}>
        <div className={`${isLoggedIn && "bg-neutral-900 border-b-[1px] border-b-[#3d3d3d] transition-all duration-200"} ${createGoal && "blur-sm brightness-50 pointer-events-none"}`}>
          <div className="mx-60 flex justify-between sticky inset-x-0 top-0 h-[80px] z-500">
            {isLoggedIn ?
