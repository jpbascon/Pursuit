...
const ForgotPassword = () => {
  ...
  useEffect(() => {
    if (!formData.email) setBtnStyle(false);
  ...
  return (
    <>
      ...
      <div className="py-50 max-w-xl mx-auto flex flex-col min-h-screen">
          ...
          <form className="w-full"
            ...
            <div className="px-15 py-10 gap-8 flex flex-col items-center w-full">
              <div className="flex flex-col items-center gap-2 w-full">
                ...
                <p className="text-zinc-400 text-sm noto-font">Send us your email. We'll help you out.</p>
              </div>
