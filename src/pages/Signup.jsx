    ...
    <>
      <div className="py-40 max-w-xl mx-auto min-h-screen">
        <div className={`flex flex-col items-center justify-center relative z-10 transition-opacity duration-500
          ...
          <form className="px-15 py-10 gap-8 flex flex-col items-center rounded-sm w-full"
            onSubmit={handleSubmit}>
            <div className="flex flex-col items-center gap-2 w-full">
              <h1 className="text-4xl font-bold">Create a <span className="font-bold size-fit">Pursuit</span> Account
              </h1>
              <p className="text-zinc-400 noto-font">Already have an account? &nbsp;
                <NavLink to="/login" className="font-bold text-[#e8e6e3] hover:brightness-70 transition-brightness duration-200">
                  Log In</NavLink>.</p>
            </div>
            <div className="flex flex-col gap-2 noto-font w-full text-[#7d7c7b]">
