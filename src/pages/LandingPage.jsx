      ...
      <div className="py-45 min-h-screen">
        <div className="max-w-7xl mx-auto flex flex-col gap-25 items-start relative z-10">
          <div className="flex flex-col">
            <h1 className={`text-9xl font-bold italic transition duration-800 ${showHeader ? "opacity-100 landing-page" : "opacity-0"}`}>Chase your dreams
              ...
              <div className="flex items-end gap-10">
                <span className={`text-9xl font-bold size-fit transition duration-800 outlined-text roboto-ront ${showSecondHeader ? "opacity-100 pursuit" : "opacity-0"}`}>Pursuit.</span>
          ...
          <div className="flex justify-start gap-5 font-bold">
            <NavLink to="/about" className={`flex-1 min-w-50 my-auto text-center text-md px-[2rem] py-[1.3rem] rounded-sm border-[2px] border-[#e8e6e3] hover:bg-[#e8e6e3] hover:text-[#111313]
            ${showButton1 ? "opacity-100 lp-buttons" : "opacity-0"}`}
              onClick={track('test_click')}>Learn more</NavLink>
            <NavLink to="/login" className={`flex-1 min-w-50 my-auto text-center text-md px-[2rem] py-[1.3rem] rounded-sm border-[2px] border-[#e8e6e3] hover:bg-[#e8e6e3] hover:text-[#111313]
