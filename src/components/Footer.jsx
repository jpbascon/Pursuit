...
const Footer = () => {
  return (
    <>
      <div className="flex flex-col justify-between h-[19rem] mt-auto px-[8%] bg-[#111313]">
        <div className="flex flex-col gap-[.5rem] justify-center items-start pt-[2rem]">
          <NavLink to="/">
            <svg width="200" height="60" viewBox="0 0 200 60" fill="none" xmlns="http://www.w3.org/2000/svg">
              <text x="35%" y="50%" dominantBaseline="central" textAnchor="middle" fill="#e8e6e3" fontSize="42" fontWeight="bold" fontStyle="italic" fontFamily="system-ui, -apple-system, sans-serif" letterSpacing="-0.02em">Pursuit</text>
            </svg>
          </NavLink>
          <div className="flex justify-between w-full">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-6">
                ...
                <a className="border-1 p-2 border-[#e8e6e3] rounded-[50%]" href="https://www.instagram.com/o.jas_n/" target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 24 24" xmlSpace="preserve" width="22" height="22" fill="#fff">
                    <g>
                ...
                <a className="border-1 p-2 border-[#e8e6e3] rounded-[50%]" href="https://x.com/o_jas_n" target="_blank">
                ...
                <a className="border-1 p-2 border-[#e8e6e3] rounded-[50%]" href="https://linkedin.com/in/a-jxson" target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 24 24" xmlSpace="preserve" width="22" height="22" fill="#fff">
                    <g>
